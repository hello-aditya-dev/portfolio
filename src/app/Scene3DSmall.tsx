...
/* ──────────────── SMALL WEBGL ORB FOR ABOUT SECTION ──────────────── */
function AnimatedOrb() {
  ...
  const uniforms = useMemo(() => ({
    ...
    uSpeed: { value: 1.2 },
    uColor1: { value: new THREE.Color('#6e7bff') },
